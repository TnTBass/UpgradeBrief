  ...
  return (
    <main>
      <header className="hero">
        ...
        >
          <svg className={theme === 'light' ? 'theme-icon-moon' : 'theme-icon-sun'} viewBox="0 0 24 24" aria-hidden="true" focusable="false">
            {theme === 'light'
              ? <path fillRule="evenodd" clipRule="evenodd" d="M9.528 1.718a.75.75 0 0 1 .162.811A9 9 0 0 0 21.47 14.11a.75.75 0 0 1 .97.977 10.5 10.5 0 1 1-12.912-13.37Z" />
